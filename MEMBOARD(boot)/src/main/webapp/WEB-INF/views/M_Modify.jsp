		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3" style="text-align : center;">회원수정</h1>
					<div class="row">
								...
								<div class="card-body">
									<form action="M_modify" method="POST" enctype="multipart/form-data">
										...
										<div class="mb-3">
											...
											<input type="password" name="MPw" class="form-control" placeholder="Password 입력">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">이름</label> 
											<input type="text" name="MName" class="form-control" placeholder="${modify.MName }">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">번호</label> 
											<input type="text" name="MPhone" class="form-control" placeholder="${modify.MPhone}">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">생년월일</label> 
											<input type="date" name="MBirth" class="form-control" placeholder="${modify.MBirth}">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">이메일</label> 
											<input type="email" name="MEmail" class="form-control" placeholder="${modify.MEmail }">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">주소</label> 
											<input type="email" name="MAddr" class="form-control" placeholder="${modify.MAddr}">
										</div>
										
										<div class="mb-3">
											<label class="form-label w-100">프로필사진</label>
											<img src="./resources/profile/${modify.MProfileName}" alt="profile" class="img-fluid rounded-circle mb-2" width="128" heigt="128"/> 
