...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3" style="text-align : center;">게시글 목록</h1>
									...
									<tbody>
										<c:forEach var="list" items="${boardList}">
											<tr>
												<td>${list.BNo}</td>
												<td><a
													href="B_view?BNo=${list.BNo}&page=${paging.page}">${list.BTitle}</a></td>
												<td>${list.BWriter}</td>
												<td>${list.BDate}</td>
												<td>${list.BHit}</td>
												
												<c:choose>
												<c:when test="${sessionScope.loginId eq list.BWriter || sessionScope.loginId eq 'admin'}">
													<td class="table-action">
														<a href="B_modiForm?BNo=${list.BNo}&page=${paging.page}"><i class="align-middle" data-feather="edit-2"></i></a> 
														<a href="B_delete?BNo=${list.BNo}&page=${paging.page}"><i class="align-middle" data-feather="trash"></i></a>
													</td>	
												</c:when>
																...
																<div class="modal-dialog modal-sm" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-body m-3">
																			<p class="mb-0">작성자 외에 수정 & 삭제가 불가능 합니다</p>
																		</div>
	...
	<c:if test="${paging.page>1}">
		<a href="B_list?page=${paging.page-1}">[이전]</a>
	</c:if>
	...
	<c:if test="${paging.page < paging.maxPage}">
		<a href="B_list?page=${paging.page+1}">[다음]</a>
	</c:if>
