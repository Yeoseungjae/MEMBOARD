									...
									<tbody>
										<c:forEach var="sList" items="${sList}">
											<tr>
												<td>${sList.BNo}</td>
												<td><a
													href="B_view?BNo=${sList.BNo}">${sList.BTitle}</a></td>
												<td>${sList.BWriter}</td>
												<td>${sList.BDate}</td>
												<td>${sList.BHit}</td>
												
												<c:choose>
												<c:when test="${sessionScope.loginId eq sList.BWriter || sessionScope.loginId eq 'admin'}">
													<td class="table-action">
														<a href="B_modiForm?BNo=${sList.BNo}"><i class="align-middle" data-feather="edit-2"></i></a> 
														<a href="B_delete?BNo=${sList.BNo}"><i class="align-middle" data-feather="trash"></i></a>
													</td>	
												</c:when>
