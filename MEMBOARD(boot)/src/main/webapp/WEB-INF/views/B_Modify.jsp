		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3" style="text-align : center;">게시글 수정하기</h1>
					<div class="row">
								...
								<div class="card-body">
									<form action="B_modify" method="POST" enctype="multipart/form-data">
										...
										<div class="mb-3">
											...
											<label class="form-label" style="font-weight : bold;">${modify.BWriter}</label> 
											<input type="hidden" name="page" value="${page}">
											<input type="hidden" name="BNo" value="${modify.BNo}">
										</div>
										<div class="mb-3">
											<label class="form-label">제목</label> 
											<input type="text" class="form-control" name="BTitle" placeholder="${modify.BTitle}">
										</div>
										<div class="mb-3">
											<label class="form-label">내용</label>
											<textarea class="form-control" placeholder="${modify.BContent}" rows="10" name="BContent"></textarea>
										</div>
										<div class="mb-3">
											<label class="form-label w-100">첨부파일</label> 
											<img src="resources/boardUpload/${modify.BFileName}" alt="BFile" class="img-fluid rounded-circle mb-2" width="128" heigt="128"/>
